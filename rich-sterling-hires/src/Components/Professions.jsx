...
const Professions = ({ profession }) => {
    ...
    return (
        <div>
            {profession === 'dev' ? (
                <div className='grid mp:grid-cols-4 mq:grid-cols-3 grid-cols-2 mq:gap-5 gap-[10px] mt-14'>
                    <div data-aos='slide-up' data-aos-delay='' className='rounded-[20px] w-full py-6 px-2 mq:border-none border-[1.7px] border-[#6C7787] shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                    ...
                    <div data-aos='slide-up' data-aos-delay='550' className='rounded-[20px] w-full py-6 px-2 mq:border-none border-[1.7px] border-[#6C7787] shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                    ...
                    <div data-aos={aosType} data-aos-delay='700' className='rounded-[20px] mp:col-start-2 border-[1.3px] border-[#6C7787] w-full py-6 px-2 shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                    ...
                    <div data-aos={aosType} data-aos-delay='850' className='rounded-[20px] w-full py-6 px-2 mq:border-none border-[1.7px] border-[#6C7787] shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                        <IoCodeSlashOutline className='mq:text-[25px] text-[21px]' />
                ...
                <div className='grid mp:grid-cols-4 mq:grid-cols-3 grid-cols-2 mq:gap-5 gap-[10px] mt-14'>
                    <div data-aos='slide-up' data-aos-delay='' className='rounded-[20px] w-full mq:border-none border-[1.7px] border-[#6C7787] py-6 px-2 shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                    ...
                    <div data-aos='slide-up' data-aos-delay='550' className='rounded-[20px] w-full mq:border-none border-[1.7px] border-[#6C7787] py-6 px-2 shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                    ...
                    <div data-aos={aosType} data-aos-delay='700' className='rounded-[20px] mp:col-start-2 w-full mq:border-none border-[1.7px] border-[#6C7787] py-6 px-2 shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                    ...
                    <div data-aos={aosType} data-aos-delay='850' className='rounded-[20px] w-full mq:border-none border-[1.7px] border-[#6C7787] py-6 px-2 shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                ...
                <div className='grid mp:grid-cols-4 mq:grid-cols-3 grid-cols-2 mq:gap-5 gap-[10px] mt-14'>
                    ...
                    <div data-aos={aosType} data-aos-delay='700' className='rounded-[20px] w-full mq:border-none border-[1.7px] border-[#6C7787] py-6 px-2 shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                    ...
                    <div data-aos={aosType} data-aos-delay='1000' className='rounded-[20px] w-full mq:border-none border-[1.7px] border-[#6C7787] py-6 px-2 shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                ...
                <div className='grid mp:grid-cols-4 mq:grid-cols-3 grid-cols-2 mq:gap-5 gap-[10px] mt-14'>
                    ...
                    <div data-aos={aosType} data-aos-delay='700' className='rounded-[20px] mp:col-start-2 mp:col-span-2 w-full mq:border-none border-[1.7px] border-[#6C7787] py-6 px-2 shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
