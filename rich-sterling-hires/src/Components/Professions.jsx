            ...
            {profession === 'dev' ? (
                <>
                    <div className='grid mp:grid-cols-4 mq:grid-cols-3 grid-cols-2 mq:gap-5 gap-[10px] mq:mt-14 mt-5'>
                        <div data-aos='zoom-in' className='rounded-[20px] w-full py-6 px-2 mq:border-none border-[1.7px] border-[#6C7787] shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                        ...
                        <div data-aos='zoom-in' data-aos-delay='250' className='rounded-[20px] w-full py-6 px-2 mq:border-none border-[1.7px] border-[#6C7787] shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                        ...
                        <div data-aos='zoom-in' data-aos-delay='400' className='rounded-[20px] w-full py-6 px-2 mq:border-none border-[1.7px] border-[#6C7787] shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                        ...
                        <div data-aos='zoom-in' data-aos-delay='550' className='rounded-[20px] w-full py-6 px-2 mq:border-none border-[1.7px] border-[#6C7787] shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                        ...
                        <div data-aos='zoom-in' className='rounded-[20px] mp:col-start-2 mq:border-none border-[1.7px] border-[#6C7787] w-full py-6 px-2 shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                ...
                <>
                    <div className='grid mp:grid-cols-4 mq:grid-cols-3 grid-cols-2 mq:gap-5 gap-[10px] mq:mt-14 mt-5'>
                        <div data-aos='zoom-in' className='rounded-[20px] w-full mq:border-none border-[1.7px] border-[#6C7787] py-6 px-2 shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                        ...
                        <div data-aos='zoom-in' data-aos-delay='250' className='rounded-[20px] w-full mq:border-none border-[1.7px] border-[#6C7787] py-6 px-2 shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                        ...
                        <div data-aos='zoom-in' data-aos-delay='400' className='rounded-[20px] w-full mq:border-none border-[1.7px] border-[#6C7787] py-6 px-2 shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                        ...
                        <div data-aos='zoom-in' data-aos-delay='550' className='rounded-[20px] w-full mq:border-none border-[1.7px] border-[#6C7787] py-6 px-2 shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                        ...
                        <div data-aos='zoom-in' data-aos-delay='250' className='rounded-[20px] mp:col-start-2 w-full mq:border-none border-[1.7px] border-[#6C7787] py-6 px-2 shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                ...
                <>
                    <div className='grid mp:grid-cols-4 mq:grid-cols-3 grid-cols-2 mq:gap-5 gap-[10px] mq:mt-14 mt-5'>
                        ...
                        <div data-aos='zoom-in' data-aos-delay='200' className='rounded-[20px] w-full mq:border-none border-[1.7px] border-[#6C7787] py-6 px-2 shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
                        ...
                        <div data-aos='zoom-in' data-aos-delay='350' className='rounded-[20px] w-full mq:border-none border-[1.7px] border-[#6C7787] py-6 px-2 shadow-md shadow-black/40 text-center flex flex-col items-center gap-4'>
